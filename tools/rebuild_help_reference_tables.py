...
CONTROL_ROWS = {
    "en": [
        ("F2", "Select Degrees in decimal mode; otherwise select Dword."),
        ("F3", "Select Radians in decimal mode; otherwise select Word."),
        ("F4", "Select Grads in decimal mode; otherwise select Byte."),
        ("F5", "Select Hex."),
        ("F6", "Select Dec."),
        ("F7", "Select Oct."),
        ("F8", "Select Bin."),
    ...
    "pt": [
        ("F2", "Seleciona Graus no modo decimal; nas outras bases, seleciona Dword."),
        ("F3", "Seleciona Radianos no modo decimal; nas outras bases, seleciona Word."),
        ("F4", "Seleciona Grads no modo decimal; nas outras bases, seleciona Byte."),
        ("F5", "Seleciona Hex."),
        ("F6", "Seleciona Dec."),
        ("F7", "Seleciona Oct."),
        ("F8", "Seleciona Bin."),
    ...
    "es": [
        ("F2", "Selecciona Grados en modo decimal; en otras bases, selecciona Dword."),
        ("F3", "Selecciona Radianes en modo decimal; en otras bases, selecciona Word."),
        ("F4", "Selecciona Grads en modo decimal; en otras bases, selecciona Byte."),
        ("F5", "Selecciona Hex."),
        ("F6", "Selecciona Dec."),
        ("F7", "Selecciona Oct."),
        ("F8", "Selecciona Bin."),
